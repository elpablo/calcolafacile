...
export const tools = [
    ...
    {
        key: "vatReverse",
        slug: { it: "calcolatore-iva-inverso", en: "vat-reverse-calculator" },
        title: { it: "Calcolatore IVA Inverso", en: "VAT Reverse Calculator" },
        description: {
            it: "Trova imponibile e quota IVA partendo da un importo lordo IVA inclusa.",
            en: "Find the net price and VAT amount from a VAT-inclusive gross amount.",
        },
        categories: ["business"],
    ...
    {
        key: "vatRemoval",
        slug: { it: "calcolatore-rimozione-iva", en: "vat-removal-calculator" },
        title: { it: "Calcolatore Rimozione IVA", en: "VAT Removal Calculator" },
        description: {
            it: "Scopri quanta IVA è inclusa in un prezzo lordo e calcola l'imponibile.",
            en: "See how much VAT is embedded in a VAT-inclusive price and calculate the net amount.",
        },
        categories: ["business"],
        releasedAt: "2026-06-06",
        tags: ["finance", "tax", "vat", "percentage", "business"],
