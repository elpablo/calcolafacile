...
import ToolLayout, { ResultBox, ToolInput } from "@/components/ToolLayout";
...
const selectClass =
    "w-full rounded border border-zinc-300 bg-white p-2 text-zinc-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-blue-400";
...
export default function UnitConverter({
    ...
    return (
        ...
        >
            <div className="mb-4">
                <label className="mb-1 block text-zinc-700 dark:text-zinc-300">Categoria</label>
                <select
                    value={categoryKey}
            ...
            <div className="grid gap-4 sm:grid-cols-[1fr_auto_1fr] sm:items-end">
                <div>
                    <label className="mb-1 block text-zinc-700 dark:text-zinc-300">Da</label>
                    <select
                        value={fromUnit}
                ...
                <button
                    type="button"
                    onClick={swapUnits}
                    className="rounded border border-zinc-300 px-3 py-2 text-sm text-zinc-700 transition hover:border-blue-300 hover:bg-blue-50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:border-blue-500 dark:hover:bg-zinc-800"
                ...
                <div>
                    <label className="mb-1 block text-zinc-700 dark:text-zinc-300">A</label>
                    <select
                        value={toUnit}
