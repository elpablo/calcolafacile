...
export default function AiCostToolsHubCore({ content }) {
    return (
        <>
            {content.faqSchema && (
                <script
            ...
            <main className="mx-auto max-w-6xl px-6 py-12">
                ...
                <section className="mb-12 rounded-2xl border border-zinc-200 bg-zinc-50 p-6 dark:border-zinc-700 dark:bg-zinc-900/60">
                    <h2 className="mb-4 text-2xl font-semibold text-zinc-900 dark:text-zinc-100">
                        {content.pricingOverviewTitle}
                    </h2>
                    <p className="mb-4 leading-7 text-zinc-600 dark:text-zinc-300">
                        {content.pricingOverviewDescription}
                    </p>
                ...
                <section className="mb-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        {content.relatedTools.slice(0, 4).map((tool) => (
